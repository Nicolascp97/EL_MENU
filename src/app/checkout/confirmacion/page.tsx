        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-bold mt-4" style={{ fontFamily: 'var(--font-fraunces)' }}>
              ...
              {!isSuccess && !isCancelled && 'No pudimos procesar el pago'}
            </h1>
            <p className="text-gray-600 mt-2 text-sm">
              ...
              {!isSuccess && !isCancelled && 'No te cobraron nada. Probá de nuevo o contactanos si el problema persiste.'}
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            <Link
              ...
              style={isSuccess && order ? undefined : { background: '#1B2B1E' }}
            >
              {isSuccess ? 'Seguir comprando' : 'Volver al catálogo'}
            </Link>
            {!isSuccess && (
              <a
